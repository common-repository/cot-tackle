 ...
 */
if (!function_exists('cot_tackle_employees')) {

    function cot_tackle_employees() {

        $singular = __('Employee', 'cot_tackle');
        $plural = __('Employees', 'cot_tackle');
        $slug = apply_filters('cot_tackle_projects_rewrite_slug', 'employees');
        ...
        $labels = array(
            ...
            'featured_image' => __('Employee Avater', 'cot_tackle'),
            'set_featured_image' => __('Set employee avater', 'cot_tackle'),
            'remove_featured_image' => __('Remove employee avater', 'cot_tackle'),
            'use_featured_image' => __('Use as employee avater', 'cot_tackle')
        );

        $args = array(
            'labels' => $labels,
            'hierarchical' => false,
            'description' => __('A post type for your employees', 'cot_tackle'),
            'taxonomies' => array(),
            'public' => true,
            'show_ui' => true,
            'show_in_menu' => true,
    ...
    add_action('init', 'cot_tackle_employees');
}